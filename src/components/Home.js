...
const HomeComponent = () => {
  ...
  const handleArrowClick = (direction) => {
    setOpacity(0);
    setTimeout(() => {
      setCurrentIndex((currentIndex + (direction === "next" ? 1 : -1)) % images.length);
      setOpacity(1);
    }, 500);
  };
      ...
      <nav className="navbar">
        <div className="container">
          <div className="logo-container">
            <img src={require("./img/imc.png")} alt="Microsoft Logo" className="logo-img" />
          </div>
          <ul className="navbar-nav">
            ...
            <li>
              <a href="#" onClick={() => scrollToSection("events")}>
                Events
              </a>
            </li>
            <li>
          ...
          <div className="block__main">
            ...
            >
              <label className="search__label">
                ...
                <input type="hidden" name="cx" defaultValue="002216470633262645991:rvefancvpay" />
                <input type="hidden" name="cof" defaultValue="FORID:11" />
              </label>
